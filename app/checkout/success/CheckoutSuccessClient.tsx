...
function InfoRow({
  ...
  return (
    <div className="flex items-center justify-between gap-4">
      <div className="text-[13px] font-medium text-neutral-600 sm:text-sm">
        {label}
      </div>
        ...
        <GlassPanel className="px-5 py-8 sm:px-8 sm:py-10">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-[14px] font-medium leading-6 text-neutral-600 sm:text-[15px]">
              We’ve received your order. Since you selected Cash on Delivery,
            ...
            <section className="space-y-4">
              <GlassPanel className="p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-[13px] font-medium text-neutral-600">
                      Keep this information for reference and delivery
                      communication.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-6 space-y-3">
                  <InfoRow
                    label="Order number"
                    value={String(order?.number ?? order?.id ?? "-")}
                  />
                  <InfoRow
                    label="Order status"
            ...
            <aside className="space-y-4 lg:sticky lg:top-24 lg:self-start">
              ...
              <GlassPanel className="p-6">
                ...
                <div className="mt-5 space-y-3">
                  ...
                  <InfoRow
                    label="Shipping"
                    value={`${order?.currency ?? ""} ${order?.shipping_total ?? "-"}`}
                  />
                  <InfoRow
                    label="Discount"
                    value={`${order?.currency ?? ""} ${order?.discount_total ?? "-"}`}
                  />
              ...
              <GlassPanel className="p-6">
                ...
                <div className="mt-3 text-[14px] leading-7 text-neutral-700">
                  Keep your phone available. Your courier or team may contact
                  you before delivery.
                </div>
